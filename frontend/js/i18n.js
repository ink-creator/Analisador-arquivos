window.ProjectI18n = (() => {
  const translations = {
    en: {
      ...
      pythonIntelligence: "Python intelligence",
      codeAnalysis: "Code analysis",
      pythonFiles: "Python files",
      functions: "Functions",
      classes: "Classes",
      averageComplexity: "Average complexity",
      fileMetrics: "Metrics by file",
      complexityHotspots: "Complexity hotspots",
      circularDependencies: "Circular dependencies",
      localDependencies: "Local dependencies",
      parsedFiles: "{parsed} of {total} files parsed",
      functionMetric: "{count} functions",
      functionMetricOne: "{count} function",
      classMetric: "{count} classes",
      classMetricOne: "{count} class",
      complexityMetric: "avg. complexity {value}",
      mostComplexMetric: "most complex: {name} ({value})",
      parseErrorMetric: "Could not parse: {error}",
      dependencyCount: "{count} connections",
      dependencyCountOne: "{count} connection",
      cycleCount: "{count} cycles",
      cycleCountOne: "{count} cycle",
      noCircularDependencies: "No circular dependencies detected.",
      noLocalDependencies: "No dependencies between Python files detected.",
    ...
    pt: {
      ...
      pythonIntelligence: "Inteligência de Python",
      codeAnalysis: "Análise de código",
      pythonFiles: "Arquivos Python",
      functions: "Funções",
      classes: "Classes",
      averageComplexity: "Complexidade média",
      fileMetrics: "Métricas por arquivo",
      complexityHotspots: "Pontos de maior complexidade",
      circularDependencies: "Dependências circulares",
      localDependencies: "Dependências locais",
      parsedFiles: "{parsed} de {total} arquivos analisados",
      functionMetric: "{count} funções",
      functionMetricOne: "{count} função",
      classMetric: "{count} classes",
      classMetricOne: "{count} classe",
      complexityMetric: "complexidade média {value}",
      mostComplexMetric: "mais complexa: {name} ({value})",
      parseErrorMetric: "Não foi possível analisar: {error}",
      dependencyCount: "{count} conexões",
      dependencyCountOne: "{count} conexão",
      cycleCount: "{count} ciclos",
      cycleCountOne: "{count} ciclo",
      noCircularDependencies: "Nenhuma dependência circular detectada.",
      noLocalDependencies: "Nenhuma dependência entre arquivos Python detectada.",
